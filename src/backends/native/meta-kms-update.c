                                      ...
                                      gpointer                   custom_page_flip_user_data)
{
  ...
  update->custom_page_flip_func = custom_page_flip_func;
  update->custom_page_flip_user_data = custom_page_flip_user_data;
}
                                        ...
                                        uint64_t                rotation)
{
  ...
  plane_assignment->has_rotation = TRUE;
...
void
meta_kms_update_unseal (MetaKmsUpdate *update)
{
