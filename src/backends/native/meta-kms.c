 ...
 * #MetaKmsMode:
 *
 * Represents a mode a CRTC and connector can be configured with. Exists both
 * modes directly derived from the devices, as well as fall back modes when the
 * CRTC supports scaling.
 *
 * #MetaKmsUpdate:
 *
